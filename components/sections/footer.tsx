        ...
        <footer className="bg-[#050505] border-t border-white/5 pt-12 lg:pt-20 pb-10">
            <div className="max-w-7xl mx-auto px-6">
                ...
                <div className="grid lg:grid-cols-4 gap-10 lg:gap-12 mb-12 lg:mb-20">
                    ...
                    {/* WhatsApp Discount */}
                    <div>
                        <h4 className="text-[#F8F5F0] font-bold text-xs tracking-[0.15em] mb-6 uppercase">10% Korting</h4>
                        <p className="text-[#94A3B8] text-xs mb-4 font-light">Ontvang direct je kortingscode via WhatsApp.</p>
